...
# CLI tools
dnf5 install -y hourglass fastfetch tmate htop btop aria2 distrobox eza bat zoxide git starship nushell
...
# Apps
dnf5 install -y virt-install libvirt-daemon-config-network libvirt-daemon-kvm qemu-kvm virt-manager virt-viewer libguestfs-tools python3-libguestfs virt-top edk2-ovmf swtpm konsole gcolor3 gparted kate code
